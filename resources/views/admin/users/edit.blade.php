...
@section('content_header')
    <h1>{{trans('Felhasználó')}}: @if($model->id) {{$model->firstname}} {{$model->lastname}} [{{$model->id}}] @else {{trans('Új')}} @endif</h1>
@stop
    ...
    <form method="post">
        ...
        <div class="box">
            ...
            <div class="box-footer">
                <a href="{{url(route('admin_users_list'))}}" class="btn btn-default">{{trans('Vissza')}}</a>
